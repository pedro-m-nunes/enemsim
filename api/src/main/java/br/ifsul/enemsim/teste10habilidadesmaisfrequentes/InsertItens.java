...
public class InsertItens {
	...
	public void run() {
		if(itemRepository.count() == 0) {
			...
			itens.add(new Item("1RJOSnrKOikOHHpRqotBNC0SK4grnDdkF", Resposta.C, new Habilidade((byte) 10), new BigDecimal("1.06024"), new BigDecimal("-0.23853"), new BigDecimal("0.20527"), new Prova(7), (short) 180));
			...
			itens.add(new Item("119KGRBqQTT7FtAjA3-5kCiZWhCagpZPK", Resposta.D, new Habilidade((byte) 3), new BigDecimal("1.15634"), new BigDecimal("2.81506"), new BigDecimal("0.10382"), new Prova(6), (short) 170));
...
//			itens.add(new Item(null, null, new Habilidade((byte) 4), null, null, null, new Prova(5), (short) 150));
			...
			itens.add(new Item("1c76qNUtKZIeA2eUYH0LUrci6XT3XDHKU", Resposta.D, new Habilidade((byte) 6), new BigDecimal("1.06810"), new BigDecimal("2.89341"), new BigDecimal("0.16386"), new Prova(5), (short) 179));
			...
			itens.add(new Item("1zHWzV1UbWPDQp1qSe1odZHckJ8a7K9mi", Resposta.D, new Habilidade((byte) 7), new BigDecimal("2.58330"), new BigDecimal("1.63345"), new BigDecimal("0.16356"), new Prova(4), (short) 180));
...
//			itens.add(new Item(null, null, new Habilidade((byte) 10), null, null, null, new Prova(3), (short) 141));
			...
			itens.add(new Item("13ghVx_IqBCHwj4VEQ4qj3v4HVkdadc2v", Resposta.C, new Habilidade((byte) 3), new BigDecimal("1.89497"), new BigDecimal("1.65188"), new BigDecimal("0.27993"), new Prova(3), (short) 176));
			...
			itens.add(new Item("1Gzzulg5kP-BVIYcJAbdCY2u5ydKnNdqG", Resposta.E, new Habilidade((byte) 2), new BigDecimal("1.38496"), new BigDecimal("1.73939"), new BigDecimal("0.14078"), new Prova(2), (short) 179));
...
//			itens.add(new Item(null, Resposta.E, new Habilidade((byte) 10), null, null, null, new Prova(1), (short) 162));
			...
			itens.add(new Item("15rTgb5yyjZRG8p0qhAKtTYLP3fIxDuib", Resposta.B, new Habilidade((byte) 2), new BigDecimal("2.17147"), new BigDecimal("2.54230"), new BigDecimal("0.18410"), new Prova(1), (short) 177));
