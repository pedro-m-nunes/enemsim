...
public class InsertItens {
	...
	public void run() {
		if(itemRepository.count() == 0) {
			...
			itens.add(new Item(null, Resposta.D, new Habilidade((byte) 10), new BigDecimal("3.41203"), new BigDecimal("3.87930"), new BigDecimal("0.05419"), new Prova(7), (short) 149));
			itens.add(new Item(null, Resposta.C, new Habilidade((byte) 8), new BigDecimal("2.15388"), new BigDecimal("2.04178"), new BigDecimal("0.28781"), new Prova(7), (short) 150));
